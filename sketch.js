...
var player, playeridle, playerrun, playerjump, playerhealth = 10,
  ...
  tutorialstate = "run",
  menu_opened = false,
  creator_pixie, creatorhealth = 10,
  creator_pixie_image,
  retry, ground, bg,
...
function preload() {
 ...
 // playerattack3 = loadAnimation("movement/adventurer-attack3-00.png", "movement/adventurer-attack3-01.png", "movement/adventurer-attack3-02.png", "movement/adventurer-attack3-03.png", "movement/adventurer-attack3-04.png", "movement/adventurer-attack3-05.png");
  ...
  firebg = loadImage("utility_images/firebg.png")
}
...
function draw() {
  ...
  if (player.x > simple_enemy.x) {
    simple_enemy.velocityX = 2;
  } else if (player.x < simple_enemy.x) {
    simple_enemy.velocityX = -2;
  }
  ...
  if (spelltimer === 0) {
    if (keyWentDown("c") && spellNo >= 1) {
      spellNo = spellNo - 1;
    } else if (keyWentDown("v") && spellNo < 6) {
      spellNo = spellNo + 1;
    }
    switch (spellNo) {
      case 1:
      ...
      case 4:
        spell_type = "water"
        spelleffect.addImage(waterspell_effect);
        spelleffect.scale = 0.25;
        break;
      case 5:
        spell_type = "fire"
        spelleffect.addImage(firespell_effect);
        spelleffect.scale = 0.15;
        break;
    }
  }

  if (simple_enemy_health <= 0) {
    simple_enemy_health = 10;
    simple_enemy.x = 0;
  }
